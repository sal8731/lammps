...
#ifdef FIX_CLASS
// clang-format off
FixStyle(crosslinked,FixCrosslinked);
// clang-format on
#else

#ifndef LMP_FIX_CROSSLINKED_H
#define LMP_FIX_CROSSLINKED_H

#include "fix.h"

namespace LAMMPS_NS {

class FixCrosslinked : public Fix {
 public:
  FixCrosslinked(class LAMMPS *, int, char **);
  virtual ~FixCrosslinked();
  int setmask();
